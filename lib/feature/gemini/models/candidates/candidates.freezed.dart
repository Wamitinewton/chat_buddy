...
mixin _$Candidates {
  ...
  String? get finishedReason => throw _privateConstructorUsedError;
...
abstract class $CandidatesCopyWith<$Res> {
  ...
  @useResult
  $Res call({Content? content, String? finishedReason, int? index});
    ...
    return _then(_value.copyWith(
      content: freezed == content
          ...
          : content // ignore: cast_nullable_to_non_nullable
              as Content?,
      finishedReason: freezed == finishedReason
          ? _value.finishedReason
          : finishedReason // ignore: cast_nullable_to_non_nullable
              as String?,
      index: freezed == index
          ? _value.index
...
class _$CandidatesImpl with DiagnosticableTreeMixin implements _Candidates {
  _$CandidatesImpl({this.content, this.finishedReason, this.index});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Candidates(content: $content, finishedReason: $finishedReason, index: $index)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('finishedReason', finishedReason))
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.finishedReason, finishedReason) ||
                other.finishedReason == finishedReason) &&
            (identical(other.index, index) || other.index == index));
  }

  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, content, finishedReason, index);
